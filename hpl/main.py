...
def setmqtt():
    ...
    #
    wni = WirepasNetworkInterface('pgcil-hpl-wnt.probussense.com', 8883, 'mqttmasteruser',
                                  'mhLFK9dC8Q00VTYsZMs7VDIPPieUb')
    ...
    wni.register_data_cb(probus_app_data, network=13317152)
    wni.register_data_cb(probus_app_data, network=13317231)
    wni.register_data_cb(probus_app_data, network=13317274)
